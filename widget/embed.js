/*
 * Drexora Support customer widget loader for GitHub Pages.
...
(function () {
  ...
  frame.src = new URL('widget.html', new URL(script.src)).toString() + '?business=' + encodeURIComponent(businessId);
  frame.setAttribute('allow', 'clipboard-write');
  frame.setAttribute('aria-label', 'Drexora Support customer service widget');
  frame.style.cssText = 'position:fixed;right:18px;bottom:18px;width:min(390px,calc(100vw - 24px));height:88px;border:0;background:transparent;z-index:2147483000;pointer-events:auto;color-scheme:light';
